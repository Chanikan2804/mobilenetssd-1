...
lineaccesstoken = 'B09m/tE83usXlJwlPtgNHgXcoae8K4ejan4Tig/WcF8PsqwLJzmuCtfEfy1rOeBAHUqeYz3B1wwcqM3VFyMd7nhdRTWK8H/e7b5E2F+AzcIG9a83j6N/ukyixJB0LbrCmtYyYgFj7wDzASJmTOkaSAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="มีไรคะสาวน้อย")
        elif msg == "เหงา":
            replyObj = TextSendMessage(text="เหงามากมั้ยงับ")
        elif msg == "มาก ทำไม":
            replyObj = TextSendMessage(text="เหงามากก็ไปหาอย่างอื่นทำ อย่ามาทำตัวว่างจ้า")
        else :
